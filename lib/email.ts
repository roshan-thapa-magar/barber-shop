...
export async function sendAppointmentNotificationToBarbers(
  appointmentData: {
    clientName: string;
    clientEmail: string;
    clientPhone: string;
    ...
    const emailHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          ${appointmentData.barberName ? `<p><strong>Assigned Barber:</strong> ${appointmentData.barberName}</p>` : ''}
        </div>
...
${appointmentData.barberName ? `- Assigned Barber: ${appointmentData.barberName}` : ''}
...
This is an automated notification. Please check your appointment schedule.
    ...
    console.log(`Appointment notification sent to ${barberEmails.length} barbers`);
