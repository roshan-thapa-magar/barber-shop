...
function DashboardContent() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const pendingAppts = appointments.filter((apt: AppointmentData) => 
        apt.status === 'pending' || apt.status === 'scheduled'
      );
      
      const completedAppts = appointments.filter((apt: AppointmentData) => 
      ...
      const monthlyRevenue = completedAppts.reduce((sum: number, apt: AppointmentData) => 
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                >
                  {shopStatus.shopStatus === 'open' ? 'Currently Open' : 'Currently Closed'}
                </Badge>
